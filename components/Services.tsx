    ...
    <section id="services" className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-gradient-to-br from-pink-100 to-pink-200 p-8 rounded-lg shadow-lg hover:shadow-xl transition cursor-pointer" onClick={onServicesClick}>
          ...
          <div className="bg-gradient-to-br from-purple-100 to-purple-200 p-8 rounded-lg shadow-lg hover:shadow-xl transition cursor-pointer" onClick={onServicesClick}>
