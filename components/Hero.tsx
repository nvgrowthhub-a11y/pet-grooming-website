    ...
    <section id="home" className="bg-gradient-to-r from-pink-200 via-pink-100 to-purple-100 py-20 px-4">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <button className="bg-pink-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-pink-700 transition text-lg">
            Book Appointments
          </button>
          <button className="border-2 border-pink-600 text-pink-600 px-8 py-3 rounded-full font-semibold hover:bg-pink-50 transition text-lg">
            Book Services
          </button>
        </div>
      </div>
